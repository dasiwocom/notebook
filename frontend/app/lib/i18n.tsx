...
const zh: Record<string, string> = {
  ...
  "settings.dropdown.language": "语言",
  "settings.dropdown.theme": "深色模式",
  "settings.dropdown.chat": "对话",
  "settings.dropdown.left": "左侧面板",
  "settings.dropdown.right": "右侧面板",
...
const en: Record<string, string> = {
  ...
  "settings.dropdown.language": "Language",
  "settings.dropdown.theme": "Dark mode",
  "settings.dropdown.chat": "Chat",
  "settings.dropdown.left": "Left panel",
  "settings.dropdown.right": "Right panel",
